...
class ServersController(wsgi.Controller):
    ...
    schema_server_rebuild_v239 = schema_servers.base_rebuild_v239
    ...
    @validation.schema(schema_server_rebuild_v219, '2.19', '2.38')
    @validation.schema(schema_server_rebuild_v239, '2.39')
